...
export function CalendarMoveCaseConfirmDialog({
  ...
  /**
   * ⚠ **iOS でボタンが押せなくなったため、1層の作りへ戻してある。**
   *    覆い＋位置決め＋中身／操作の入れ子（cca2104〜328addd）は PC では
   *    正しく動いたが、iOS の WebView では中身までタップが届くのに
   *    ボタンに当たらなくなった（診断で 本体4 / 実行0 を実測）。
   *    原因を特定できていないので、構造は単純なまま保つこと。
   *
